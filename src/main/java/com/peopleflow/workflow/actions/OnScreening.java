...
@Component
@Log
public class OnScreening implements Action<HiringStates, HiringEvents> {

    private final ApplicationRepo applicationRepo;

    @Autowired
    public OnScreening(ApplicationRepo applicationRepo) {
    ...
    public void execute(StateContext<HiringStates, HiringEvents> context) {
        ...
        ApplicationScreeningRequest applicationScreeningRequest = extendedState.get("application", ApplicationScreeningRequest.class);
